...
using KanDDDinsky.Core.Tracking;
...
using Format = KanDDDinsky.Books.Entities.Format;
...
public static class BookEntityMapper
{
    public static Book MapToAggregate(this BookEntity book, IBookFactory bookFactory) =>
        bookFactory.Create(
            ...
            (null as IKanDDDinsky)!, //TODO: Change that
    ...
    public static BookEntity MapToEntity(this Book book, KanDDDinskyDbContext dbContext) =>
        new BookEntity
        {
            Id = book.Id.Value,
