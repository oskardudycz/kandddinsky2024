...
using KanDDDinsky.Books.Events;
...
public class Book: Aggregate<BookId>
{
    ...
    private readonly IKanDDDinsky KanDDDinsky;
    ...
    public static Book CreateDraft(
        ...
        new Book(bookId, State.Writing, title, author, KanDDDinsky, publisher, edition, genre);
    ...
    public void MoveToPrinting()
    {
        ...
        if (!KanDDDinsky.IsGenreLimitReached(Genre))
    ...
    public class Factory: IBookFactory
    {
        public Book Create(
            ...
            new Book(
                bookId, state, title, author, KanDDDinsky, publisher, edition,
